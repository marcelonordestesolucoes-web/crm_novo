  ...
  <NavLink
    ...
    className={({ isActive }) =>
      [
        ...
        isActive
          ? 'bg-white/[0.08] text-white shadow-[0_8px_16px_rgba(0,0,0,0.2)] border border-white/20 backdrop-blur-md'
...
export const Sidebar = () => {
  ...
  return (
    <nav className="w-[280px] h-screen fixed left-0 top-0 bg-[rgba(18,18,24,0.94)] prism-glass text-slate-400 flex flex-col z-50 border-r border-black/50 antialiased
      ...
      <div className="absolute -top-24 -left-24 w-64 h-64 bg-indigo-500/10 blur-[80px] rounded-full animate-pulse duration-[10000ms] pointer-events-none" />
      <div className="absolute bottom-20 right-0 w-48 h-48 bg-purple-500/5 blur-[80px] rounded-full animate-pulse duration-[8000ms] pointer-events-none" />

      {/* ✨ HOLOGRAPHIC RIM — Difração de luz vertical na borda direita */}
      <div className="absolute right-0 inset-y-0 w-px bg-gradient-to-b from-transparent via-white/20 to-transparent z-30" />
      ...
      <div className="relative z-20 flex flex-col h-full overflow-y-auto">
        ...
        <div className="mt-auto pb-4 flex flex-col items-center">
          <div className="px-6 w-full mb-6">
            <button className="w-full bg-white/[0.08] text-white py-3.5 rounded-xl font-inter font-bold text-sm shadow-sm flex items-center justify-center gap-2 border border-white/10 hover:bg-white/[0.15] hover:border-white/20 transition-all duration-300 backdrop-blur-md">
